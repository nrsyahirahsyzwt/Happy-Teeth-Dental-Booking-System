...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES['photo']['name'])) {
        ...
        if (in_array($ext, $allowed)) {
            ...
            $photoName = "patient_{$patient_id}_" . time() . "." . $ext;
...
/* ================= PROFILE IMAGE ================= */
if (!empty($patient['photo']) && file_exists($uploadDir . $patient['photo'])) {
    $photo = $uploadUrl . $patient['photo'];
} else {
...
<h4 class="fw-bold text-center mb-4">
    <i class="fa fa-user"></i> Edit Patient Profile
</h4>
